#include "trainedworker.h"
#include "tiles/tilebase.h"
#include "interfaces/igameeventhandler.h"
#include "interfaces/iobjectmanager.h"

TrainedWorker::TrainedWorker(const std::shared_ptr<Course::iGameEventHandler> &eventhandler,
...
std::string TrainedWorker::getType() const
{
    return "TrainedWorker";
}

bool TrainedWorker::canBePlacedOnTile(const std::shared_ptr<Course::TileBase> &target) const
{
    return target->getOwner() == getOwner() and
            Course::WorkerBase::canBePlacedOnTile(target);
}

void TrainedWorker::doSpecialAction()
{

}

const Course::ResourceMapDouble TrainedWorker::tileWorkAction()
{
